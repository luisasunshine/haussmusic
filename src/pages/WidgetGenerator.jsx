    ...
    <div className="min-h-screen pb-32">
      ...
      <div className="relative px-6 lg:px-8 py-12 mb-8">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          >
            ...
            <div>
              <h1 className="text-4xl font-black v-chrome-text v-display">Widget do VELVET MUSIC</h1>
              <p className="text-velvet-dim mt-1">Incorpore músicas do VELVET MUSIC no seu site</p>
            </div>
          </motion.div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
              <h2 className="text-xl font-bold mb-4 flex items-center gap-2 v-chrome-text">
                <Settings className="w-5 h-5 text-velvet-silver" />
                Configurações do Widget
              </h2>

              <div className="space-y-4">
                <div>
                  <label className="text-sm text-velvet-dim mb-2 block">Tipo de Conteúdo</label>
                ...
                <div>
                  <label className="text-sm text-velvet-dim mb-2 block">Tema</label>
                ...
                <div>
                  <label className="text-sm text-velvet-dim mb-2 block">Quantidade</label>
                  <Input
                    type="number"
                    value={config.limit}
                ...
                <div>
                  <label className="text-sm text-velvet-dim mb-2 block">Buscar (opcional)</label>
                  <Input
                    value={config.search}
                ...
                <div>
                  <label className="text-sm text-velvet-dim mb-2 block">Gênero (opcional)</label>
                ...
                <div>
                  <label className="text-sm text-velvet-dim mb-2 block">Artista (opcional)</label>
                  <Input
                    value={config.artist}
            ...
            <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  onClick={copyCode}
                  className="flex items-center gap-2 px-4 py-2 rounded-lg bg-velvet-silver hover:bg-velvet-silver text-white transition-colors"
                >
                  {copied ? (
          ...
          >
            <div className="bg-white/5 rounded-2xl p-6 border border-white/10 sticky top-6">
              <h2 className="text-xl font-bold mb-4 flex items-center gap-2 v-chrome-text">
                <Eye className="w-5 h-5 text-velvet-silver" />
                Preview
              </h2>
              <div className="bg-velvet-surface rounded-xl p-4 border border-white/10">
              ...
              <div className="mt-4 p-4 bg-velvet-silver/10 border border-velvet-steel/30 rounded-lg">
                <p className="text-sm text-velvet-text">
        ...
        >
          ...
          {/* Widget HTML */}
          <div className="bg-gradient-to-br from-velvet-steel/10 to-velvet-steel/10 rounded-2xl p-6 border border-velvet-steel/30">
            <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <Music2 className="w-5 h-5 text-velvet-silver" />
              Usando o Widget Completo
            </h3>
            <div className="space-y-3 text-velvet-silver">
            ...
            <div className="mt-4 p-4 bg-velvet-silver/20 rounded-lg border border-velvet-steel/30">
              <p className="text-sm text-velvet-text">
