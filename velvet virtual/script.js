...
async function loadVelvetPodcasts() {
  ...
  try {
    ...
    podcasts.forEach((podcast, index) => {
      ...
      link.href = releaseId ? `https://velvetmusic.vercel.app/Release?id=${encodeURIComponent(releaseId)}&song=${encodeURIComponent(podcast.id)}&autoplay=1` : 'https://velvetmusic.vercel.app/';
